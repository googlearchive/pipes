...
class ViewAppComponent0 extends AppView<import1.AppComponent> {
  ...
  ComponentRef<import1.AppComponent> build() {
    ...
    import2.Text _text_43 = new import2.Text('The hero\'s birthday is ');
    _el_42.append(_text_43);
    _text_44 = new import2.Text('');
    _el_42.append(_text_44);
    _el_45 = createAndAppend(doc, 'p', parentRenderNode);
    import2.Text _text_46 = new import2.Text('The hero\'s birthday is ');
    _el_45.append(_text_46);
    _text_47 = new import2.Text('');
    _el_45.append(_text_47);
    import2.Text _text_48 = new import2.Text(' ');
    _el_45.append(_text_48);
    _el_49 = createAndAppend(doc, 'hr', parentRenderNode);
    _el_50 = createAndAppend(doc, 'a', parentRenderNode);
    createAttr(_el_50, 'id', 'happy-birthday2');
    _el_51 = createAndAppend(doc, 'h2', parentRenderNode);
    import2.Text _text_52 = new import2.Text('Hero Birthday v2');
    ...
    _el_56 = createAndAppend(doc, 'h2', parentRenderNode);
    import2.Text _text_57 = new import2.Text('Birthday Pipe Chaining');
    _el_56.append(_text_57);
    _el_58 = createAndAppend(doc, 'p', parentRenderNode);
    import2.Text _text_59 = new import2.Text('The chained hero\'s birthday is\n  ');
    _el_58.append(_text_59);
    _text_60 = new import2.Text('');
    _el_58.append(_text_60);
    _el_61 = createAndAppend(doc, 'p', parentRenderNode);
    import2.Text _text_62 = new import2.Text('The chained hero\'s birthday is\n  ');
    _el_61.append(_text_62);
    _text_63 = new import2.Text('');
    _el_61.append(_text_63);
    _el_64 = createAndAppend(doc, 'p', parentRenderNode);
    import2.Text _text_65 = new import2.Text('The chained hero\'s birthday is\n  ');
    _el_64.append(_text_65);
    _text_66 = new import2.Text('');
    _el_64.append(_text_66);
    _el_67 = createAndAppend(doc, 'hr', parentRenderNode);
    _el_68 = createAndAppend(doc, 'a', parentRenderNode);
    createAttr(_el_68, 'id', 'power-booster');
  ...
  void detectChangesInternal() {
    ...
    final currVal_0 = import23.interpolate0(_pipe_date_0_0(_ctx.birthday));
    if (!identical(_expr_0, currVal_0)) {
      _text_44.text = currVal_0;
      _expr_0 = currVal_0;
    }
    final currVal_1 = import23.interpolate0(_pipe_date_0_1(_ctx.birthday, 'MM/dd/yy'));
    if (!identical(_expr_1, currVal_1)) {
      _text_47.text = currVal_1;
      _expr_1 = currVal_1;
    }
    final currVal_2 = import23.interpolate0(_pipe_uppercase_1_0(_pipe_date_0_2(_ctx.birthday)));
    if (!identical(_expr_2, currVal_2)) {
      _text_60.text = currVal_2;
      _expr_2 = currVal_2;
    }
    final currVal_3 = import23.interpolate0(_pipe_uppercase_1_1(_pipe_date_0_3(_ctx.birthday, 'fullDate')));
    if (!identical(_expr_3, currVal_3)) {
      _text_63.text = currVal_3;
      _expr_3 = currVal_3;
    }
    final currVal_4 = import23.interpolate0(_pipe_uppercase_1_2(_pipe_date_0_4(_ctx.birthday, 'fullDate')));
    if (!identical(_expr_4, currVal_4)) {
      _text_66.text = currVal_4;
      _expr_4 = currVal_4;
    }
