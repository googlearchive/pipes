define(['dart_sdk', 'packages/angular/angular.template', 'packages/pipe_examples/app_component.template', 'packages/angular/src/platform/bootstrap', 'packages/pipe_examples/app_component'], function(dart_sdk, angular, app_component, bootstrap, app_component$) {
  'use strict';
