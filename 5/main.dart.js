...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      }, null, "get$noSuchMethod", 2, 0, null, 21],
    ...
    Primitives_dateNow: [function() {
      return Date.now();
    }, "call$0", "_js_helper_Primitives_dateNow$closure", 0, 0, 69],
    ...
    }, null, null, 14, 0, null, 40, 41, 35, 18, 19, 44, 32],
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:83;_box_0,$arguments,namedArgumentList",
    ...
    Stream_Stream$periodic: function(period, computation, $T) {
      ...
      controller = new P._SyncStreamController(null, 0, null, new P.closure6(watch, t3), new P.closure7(t1, watch), new P.closure8(t1, period, watch, t2, t3), new P.closure9(t1), [$T]);
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 71, 9],
    _nullErrorHandler: [function(error, stackTrace) {
      $.Zone__current.handleUncaughtError$2(error, stackTrace);
    }, function(error) {
      return P._nullErrorHandler(error, null);
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 9, 4, 5, 8],
    ...
    }, "call$5", "async___rootHandleUncaughtError$closure", 10, 0, 22],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 72],
    ...
    }, "call$5", "async___rootCreateTimer$closure", 10, 0, 73],
    _rootCreatePeriodicTimer: [function($self, $parent, zone, duration, callback) {
      return P.Timer__createPeriodicTimer(duration, C.C__RootZone !== zone ? zone.bindUnaryCallback$1(callback) : callback);
    }, "call$5", "async___rootCreatePeriodicTimer$closure", 10, 0, 74],
    _rootPrint: [function($self, $parent, zone, line) {
      H.printString(H.S(line));
    }, "call$4", "async___rootPrint$closure", 8, 0, 75],
    _printToZone: [function(line) {
      J.print$1$x($.Zone__current, line);
    }, "call$1", "async___printToZone$closure", 2, 0, 76],
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 77, 1, 2, 3, 50, 38],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 9, 4, 5, 8],
    ...
    sendEvent: {
      "^": "Closure:2;_box_0,computation,watch",
      call$0: function() {
    ...
    startPeriodicTimer: {
      "^": "Closure:2;_box_0,period,sendEvent",
      call$0: function() {
    ...
    startPeriodicTimer_closure: {
      "^": "Closure:70;sendEvent",
      call$1: [function(timer) {
        this.sendEvent.call$0();
      }, null, null, 2, 0, null, 60, "call"]
    },
    closure6: {
      "^": "Closure:0;watch,startPeriodicTimer",
      call$0: function() {
    ...
    closure8: {
      "^": "Closure:0;_box_0,period,watch,sendEvent,startPeriodicTimer",
      call$0: function() {
        var t1, t2, elapsed;
        t1 = this.watch;
        t2 = t1._stop;
        ...
        t1.start$0(0);
        t1 = this._box_0;
        t1.timer = P.Timer_Timer(new P.Duration(this.period._duration - elapsed._duration), new P._closure(t1, this.sendEvent, this.startPeriodicTimer));
      }
    },
    _closure: {
      "^": "Closure:0;_box_0,sendEvent,startPeriodicTimer",
      call$0: [function() {
    ...
    _StreamController: {
      ...
      _recordCancel$1: function(subscription) {
        var result, e, s, exception, result0, t1;
        result = null;
        if ((this._state & 8) !== 0)
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 42, 5, 8],
    ...
    }, "call$1", "convert___defaultToEncodable$closure", 2, 0, 1, 26],
    _JsonMap: {
    ...
    }, "call$1", "js___convertToJS$closure", 2, 0, 1, 15],
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 78, 15],
    ...
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 79],
    createNgZone: [function() {
      return Y.NgZone$(false);
    }, "call$0", "modules__createNgZone$closure", 0, 0, 80],
    ...
    }, "call$0", "modules__createRandomAppId$closure", 0, 0, 16],
    ...
    ObservableStrategy: {
      "^": "Object;",
      createSubscription$2: function(stream, updateLatestValue) {
        return stream.listen$2$onError(updateLatestValue, new B.ObservableStrategy_createSubscription_closure());
      },
      dispose$1: function(subscription) {
        subscription.cancel$0(0);
      }
    },
    ObservableStrategy_createSubscription_closure: {
      "^": "Closure:1;",
      call$1: [function(e) {
    ...
    AsyncPipe: {
      ...
      _selectStrategy$1: function(obj) {
        ...
        if (!!t1.$isFuture)
          ...
          return $.$get$_observableStrategy();
        else
          throw H.wrapException(K.InvalidPipeArgumentException$(C.Type_AsyncPipe_2Ch, obj));
      },
      _dispose$0: function() {
      ...
      static: {
        AsyncPipe__maybeStreamIdentical: function(a, b) {
          ...
          if (a == null ? b != null : a !== b) {
            ...
            return !!t1.$isStream && b instanceof P.Stream && t1.$eq(a, b);
          }
          return true;
        }
      }
  ...
  }], ["", "package:angular/src/common/pipes/date_pipe.dart",, R, {
    "^": "",
    DatePipe: {
      "^": "Object;",
      transform$2: [function(_, value, pattern) {
        var t1, locale, formatter, matches;
        if (value == null)
          return;
        if (!(value instanceof P.DateTime || typeof value === "number"))
          throw H.wrapException(K.InvalidPipeArgumentException$(C.Type_DatePipe_oiE, value));
        if (typeof value === "number") {
          t1 = 0 + value;
          value = new P.DateTime(t1, false);
          value.DateTime$_withValue$2$isUtc(t1, false);
        }
        t1 = $.$get$DatePipe__ALIASES();
        if (t1.containsKey$1(0, pattern))
          pattern = t1.$index(0, pattern);
        locale = T.Intl_defaultLocale();
        locale = locale == null ? locale : J.replaceAll$2$s(locale, "-", "_");
        formatter = new T.DateFormat(null, null, null, null, null, null, null);
        formatter._locale = T.Intl_verifiedLocale(locale, T.intl_DateFormat_localeExists$closure(), T.intl_Intl__throwLocaleError$closure());
        formatter.addPattern$1(null);
        matches = $.$get$_multiPartRegExp().firstMatch$1(pattern);
        if (matches != null) {
          t1 = matches._match;
          if (1 >= t1.length)
            return H.ioore(t1, 1);
          formatter.addPattern$1(t1[1]);
          if (2 >= t1.length)
            return H.ioore(t1, 2);
          formatter.addPattern$2(t1[2], ", ");
        } else
          formatter.addPattern$1(pattern);
        return formatter.format$1(value);
      }, function($receiver, value) {
        return this.transform$2($receiver, value, "mediumDate");
      }, "transform$1", "call$2", "call$1", "get$transform", 2, 2, 45],
    ...
    InvalidPipeArgumentException: {
      ...
      static: {
        InvalidPipeArgumentException$: function(type, value) {
          return new K.InvalidPipeArgumentException("Invalid argument '" + H.S(value) + "' for pipe '" + H.S(type) + "'");
        }
      }
    }
  ...
  }], ["", "package:angular/src/common/pipes/json_pipe.dart",, L, {
    "^": "",
    JsonPipe: {
      "^": "Object;"
    }
    ...
    UpperCasePipe: {
      ...
      transform$1: [function(_, value) {
        if (value == null)
          return value;
        if (typeof value !== "string")
          throw H.wrapException(K.InvalidPipeArgumentException$(C.Type_UpperCasePipe_fyO, value));
        return value.toUpperCase();
      }, "call$1", "get$transform", 2, 0, 10]
    }
    ...
    initReflector_closure15: {
      ...
      }, null, null, 6, 0, null, 7, 10, 28, "call"]
    }
  ...
  }], ["", "package:angular/src/core/change_detection/pipe_transform.dart",, E, {
    "^": "",
    PipeTransform: {
      "^": "Object;"
    }
    ...
    NgZone: {
      ...
      }, "call$4", "get$_ng_zone$_scheduleMicrotask", 8, 0, 21, 1, 2, 3, 11],
      ...
      }, "call$5", "get$_onErrorWithoutLongStackTrace", 10, 0, 22, 1, 2, 3, 5, 64],
      ...
      }, "call$5", "get$_createTimer", 10, 0, 53, 1, 2, 3, 51, 11],
    ...
    _RuntimeInjector: {
      ...
      useClass$2$deps: [function(clazz, deps) {
        ...
        return t1;
      }, null, "get$useClass", 2, 3, null, 4, 52, 53]
    },
    _FlatProviders: {
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", null, null, null, "get$$call", 2, 4, null, 4, 4, 5, 54, 55],
      $isFunction: 1
    }
    ...
    PublicTestability: {
      ...
      }, "call$0", "get$isStable", 0, 0, 55],
      whenStable$1: [function(callback) {
        this._testability.whenStable$1(callback);
      }, "call$1", "get$whenStable", 2, 0, 7, 14],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 85, 4, 4, 22, 57, 58],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 59, 22, 24, "call"]
    },
    ...
    CheckboxControlValueAccessor: {
      ...
      writeValue$1: function(value) {
        J.set$checked$x(this._checkbox_value_accessor$_elementRef, value);
      },
    ...
    selectValueAccessor: function(dir, valueAccessors) {
      ...
      for (t1 = valueAccessors.length, defaultAccessor = null, builtinAccessor = null, customAccessor = null, _i = 0; _i < valueAccessors.length; valueAccessors.length === t1 || (0, H.throwConcurrentModificationError)(valueAccessors), ++_i) {
        ...
        if (!!t2.$isDefaultValueAccessor)
          ...
          if (!t2.$isCheckboxControlValueAccessor)
    ...
    }, "call$1", "intl_Intl__throwLocaleError$closure", 2, 0, 10],
    ...
    DateFormat: {
      "^": "Object;_locale,_intl$_pattern,_formatFieldsPrivate,_useNativeDigits,_digitMatcher,_localeZeroCodeUnit,_localeZero",
      ...
      _localizeDigits$1: function(numberString) {
        var t1, t2, newDigits, i, t3, t4, t5;
        t1 = this._useNativeDigits;
        if (t1 == null) {
          t1 = this._locale;
          $.$get$DateFormat__useNativeDigitsByDefault().$index(0, t1);
          this._useNativeDigits = true;
          t1 = true;
        }
        if (t1) {
          t1 = this._localeZeroCodeUnit;
          t2 = $.$get$DateFormat__asciiZeroCodeUnit();
          t2 = t1 == null ? t2 != null : t1 !== t2;
          t1 = t2;
        } else
          t1 = false;
        ...
        for (t2 = newDigits.length, i = 0; i < t1; ++i) {
          t3 = C.JSString_methods._codeUnitAt$1(numberString, i);
          t4 = this._localeZeroCodeUnit;
          if (t4 == null) {
            t4 = this._localeZero;
            if (t4 == null) {
              t4 = this._useNativeDigits;
              if (t4 == null) {
                t4 = this._locale;
                $.$get$DateFormat__useNativeDigitsByDefault().$index(0, t4);
                this._useNativeDigits = true;
                t4 = true;
              }
              if (t4) {
                if (!J.$eq$(this._locale, $.lastDateSymbolLocale)) {
                  ...
                  t5.toString;
                  $.cachedDateSymbols = J.$eq$(t4, "en_US") ? t5.fallbackData : t5._throwException$0();
                }
                $.cachedDateSymbols.get$ZERODIGIT();
              }
              this._localeZero = "0";
              t4 = "0";
            }
            t4 = C.JSString_methods._codeUnitAt$1(t4, 0);
            this._localeZeroCodeUnit = t4;
          }
          t5 = $.$get$DateFormat__asciiZeroCodeUnit();
          if (typeof t5 !== "number")
            return H.iae(t5);
          if (i >= t2)
            return H.ioore(newDigits, i);
          newDigits[i] = t3 + t4 - t5;
        }
      ...
      static: {
        ...
        }, "call$1", "intl_DateFormat_localeExists$closure", 2, 0, 81],
    ...
    _DateFormatPatternField: {
      ...
      formatField$1: function(date) {
        ...
        switch (t2.$index(t1, 0)) {
          ...
          case "d":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$day(), t1, "0"));
          case "D":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + this.dayNumberInYear$1(date), t1, "0"));
          case "E":
            t3 = this.parent;
          ...
          case "h":
            ...
            if (hours === 0)
              hours = 12;
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + hours, t1, "0"));
          case "H":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$hour(), t1, "0"));
          case "K":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + C.JSInt_methods.$mod(date.get$hour(), 12), t1, "0"));
          case "k":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$hour(), t1, "0"));
          case "L":
          ...
          case "m":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$minute(), t1, "0"));
          case "Q":
          ...
          case "s":
            t1 = t2.get$length(t1);
            return this.parent._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$second(), t1, "0"));
          case "v":
          ...
          case "y":
            ...
            if (J.$eq$(t2.get$length(t1), 2))
              t1 = t3._localizeDigits$1(C.JSString_methods.padLeft$2("" + C.JSInt_methods.$mod(year, 100), 2, "0"));
            else {
              t1 = t2.get$length(t1);
              t1 = t3._localizeDigits$1(C.JSString_methods.padLeft$2("" + year, t1, "0"));
            }
            return t1;
          case "z":
      ...
      formatMonth$1: function(date) {
        ...
        switch (t2.get$length(t1)) {
          case 5:
            t1 = t3.get$dateSymbols().get$NARROWMONTHS();
            t2 = date.get$month() - 1;
            if (t2 < 0 || t2 >= 12)
              return H.ioore(t1, t2);
            return t1[t2];
          case 4:
            t1 = t3.get$dateSymbols().get$MONTHS();
            t2 = date.get$month() - 1;
            if (t2 < 0 || t2 >= 12)
              return H.ioore(t1, t2);
            return t1[t2];
          case 3:
            t1 = t3.get$dateSymbols().get$SHORTMONTHS();
            t2 = date.get$month() - 1;
            if (t2 < 0 || t2 >= 12)
              return H.ioore(t1, t2);
            return t1[t2];
          default:
            t1 = t2.get$length(t1);
            return t3._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$month(), t1, "0"));
        }
      },
      formatFractionalSeconds$1: function(date) {
        var t1, basic, t2, t3;
        t1 = this.parent;
        basic = t1._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$millisecond(), 3, "0"));
        t2 = this.pattern;
        t3 = J.getInterceptor$asx(t2);
        if (J.$gt$n(J.$sub$n(t3.get$length(t2), 3), 0))
          return basic + t1._localizeDigits$1(C.JSString_methods.padLeft$2("0", J.$sub$n(t3.get$length(t2), 3), "0"));
        else
          return basic;
      },
      formatStandaloneDay$1: function(date) {
        ...
        switch (J.get$length$asx(this.pattern)) {
          case 5:
            return t1.get$dateSymbols().get$STANDALONENARROWWEEKDAYS()[C.JSInt_methods.$mod(date.get$weekday(), 7)];
          case 4:
            return t1.get$dateSymbols().get$STANDALONEWEEKDAYS()[C.JSInt_methods.$mod(date.get$weekday(), 7)];
          case 3:
            return t1.get$dateSymbols().get$STANDALONESHORTWEEKDAYS()[C.JSInt_methods.$mod(date.get$weekday(), 7)];
          default:
            return t1._localizeDigits$1(C.JSString_methods.padLeft$2("" + date.get$day(), 1, "0"));
        }
      },
      formatStandaloneMonth$1: function(date) {
        ...
        switch (t2.get$length(t1)) {
          case 5:
            t1 = t3.get$dateSymbols().get$STANDALONENARROWMONTHS();
            t2 = date.get$month() - 1;
            if (t2 < 0 || t2 >= 12)
              return H.ioore(t1, t2);
            return t1[t2];
          case 4:
            t1 = t3.get$dateSymbols().get$STANDALONEMONTHS();
            t2 = date.get$month() - 1;
            if (t2 < 0 || t2 >= 12)
              return H.ioore(t1, t2);
            return t1[t2];
          case 3:
            t1 = t3.get$dateSymbols().get$STANDALONESHORTMONTHS();
            t2 = date.get$month() - 1;
            if (t2 < 0 || t2 >= 12)
              return H.ioore(t1, t2);
            return t1[t2];
      ...
      formatQuarter$1: function(date) {
        ...
        switch (t2.get$length(t1)) {
          case 4:
            t1 = t3.get$dateSymbols().get$QUARTERS();
            if (quarter < 0 || quarter >= 4)
              return H.ioore(t1, quarter);
            return t1[quarter];
          case 3:
            t1 = t3.get$dateSymbols().get$SHORTQUARTERS();
            if (quarter < 0 || quarter >= 4)
              return H.ioore(t1, quarter);
            return t1[quarter];
          default:
            t1 = t2.get$length(t1);
            return t3._localizeDigits$1(C.JSString_methods.padLeft$2("" + (quarter + 1), t1, "0"));
        }
      },
      dayNumberInYear$1: function(date) {
        ...
        t1 = C.JSDouble_methods.floor$0(30.6 * date.get$month() - 91.4);
        t2 = date.get$day();
        t3 = date.get$year();
    ...
    UninitializedLocaleData: {
      "^": "Object;message>,fallbackData,_badMessages",
      $index: function(_, key) {
  ...
  }], ["", "package:pipe_examples/app_component.dart",, Q, {
    "^": "",
    AppComponent: {
      "^": "Object;birthday<"
    }
  }], ["", "package:pipe_examples/app_component.template.dart",, V, {
    "^": "",
    ...
    ViewAppComponent0: {
      "^": "AppView;_app_component_template$_el_0,_el_1,_app_component_template$_el_3,_app_component_template$_el_5,_el_6,_app_component_template$_el_8,_el_9,_el_11,_app_component_template$_el_12,_app_component_template$_el_14,_el_15,_el_17,_app_component_template$_el_18,_el_20,_el_21,_el_23,_el_24,_el_26,_el_27,_el_29,_el_30,_el_32,_el_33,_el_34,_el_35,_el_37,_compView_37,_HeroBirthdayComponent_37_4,_el_38,_el_39,_el_40,_el_42,_text_43,_el_44,_text_45,_el_46,_el_47,_el_48,_el_50,_compView_50,_HeroBirthday2Component_50_4,_el_51,_el_52,_el_53,_el_55,_text_56,_el_57,_text_58,_el_59,_text_60,_el_61,_el_62,_el_63,_compView_63,_PowerBoosterComponent_63_4,_el_64,_el_65,_el_66,_compView_66,_PowerBoostCalculatorComponent_66_4,_el_67,_el_68,_el_69,_compView_69,_FlyingHeroesComponent_69_4,_el_70,_el_71,_el_72,_compView_72,_FlyingHeroesImpureComponent_72_4,_el_73,_el_74,_el_75,_compView_75,_HeroAsyncMessageComponent_75_4,_el_76,_el_77,_el_78,_compView_78,_HeroListComponent_78_4,_el_79,_expr_0,_expr_1,_expr_2,_expr_3,_expr_4,_app_component_template$_pipe_date_0,_app_component_template$_pipe_date_0_0,_pipe_date_0_1,_pipe_date_0_2,_pipe_date_0_3,_pipe_date_0_4,_pipe_uppercase_1,_pipe_uppercase_1_0,_pipe_uppercase_1_1,_pipe_uppercase_1_2,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, doc, t1, _text_4, _text_7, _text_10, _text_13, _text_16, _text_19, _text_22, _text_25, _text_28, _text_31, t2, t3;
        ...
        J.setAttribute$2$x(t1, "id", "toc");
        t1 = S.createAndAppend(doc, "h1", parentRenderNode);
        this._el_1 = t1;
        t1.appendChild(doc.createTextNode("Pipes"));
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_3 = t1;
        J.setAttribute$2$x(t1, "href", "#happy-birthday1");
        _text_4 = doc.createTextNode("Happy Birthday v1");
        ...
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_6 = t1;
        J.setAttribute$2$x(t1, "href", "#birthday-date-pipe");
        _text_7 = doc.createTextNode("Birthday DatePipe");
        this._el_6.appendChild(_text_7);
        this._app_component_template$_el_8 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_9 = t1;
        J.setAttribute$2$x(t1, "href", "#happy-birthday2");
        _text_10 = doc.createTextNode("Happy Birthday v2");
        this._el_9.appendChild(_text_10);
        this._el_11 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_12 = t1;
        J.setAttribute$2$x(t1, "href", "#birthday-pipe-chaining");
        _text_13 = doc.createTextNode("Birthday Pipe Chaining");
        this._app_component_template$_el_12.appendChild(_text_13);
        this._app_component_template$_el_14 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_15 = t1;
        J.setAttribute$2$x(t1, "href", "#power-booster");
        _text_16 = doc.createTextNode("Power Booster custom pipe");
        ...
        J.setAttribute$2$x(t1, "href", "#power-boost-calc");
        _text_19 = doc.createTextNode("Power Boost Calculator custom pipe with params");
        this._app_component_template$_el_18.appendChild(_text_19);
        this._el_20 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_21 = t1;
        J.setAttribute$2$x(t1, "href", "#flying-heroes");
        _text_22 = doc.createTextNode("Flying Heroes filter pipe (pure)");
        this._el_21.appendChild(_text_22);
        this._el_23 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_24 = t1;
        J.setAttribute$2$x(t1, "href", "#flying-heroes-impure");
        _text_25 = doc.createTextNode("Flying Heroes filter pipe (impure)");
        this._el_24.appendChild(_text_25);
        this._el_26 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_27 = t1;
        J.setAttribute$2$x(t1, "href", "#hero-message");
        _text_28 = doc.createTextNode("Async Hero Message and AsyncPipe");
        this._el_27.appendChild(_text_28);
        this._el_29 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_30 = t1;
        J.setAttribute$2$x(t1, "href", "#hero-list");
        _text_31 = doc.createTextNode("Hero List with caching FetchJsonPipe");
        this._el_30.appendChild(_text_31);
        this._el_32 = S.createAndAppend(doc, "br", parentRenderNode);
        this._el_33 = S.createAndAppend(doc, "hr", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_34 = t1;
        J.setAttribute$2$x(t1, "id", "happy-birthday1");
        t1 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._el_35 = t1;
        t1.appendChild(doc.createTextNode("Hero Birthday v1"));
        t1 = G.ViewHeroBirthdayComponent0$(this, 37);
        this._compView_37 = t1;
        t1 = t1.rootEl;
        this._el_37 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new U.HeroBirthdayComponent(new P.DateTime(H.checkInt(H.Primitives_valueFromDecomposedDate(1988, 4, 15, 0, 0, 0, 0, false)), false));
        this._HeroBirthdayComponent_37_4 = t1;
        t2 = this._compView_37;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        this._el_38 = S.createAndAppend(doc, "hr", parentRenderNode);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_39 = t2;
        J.setAttribute$2$x(t2, "id", "birthday-date-pipe");
        t2 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._el_40 = t2;
        t2.appendChild(doc.createTextNode("Birthday DatePipe"));
        ...
        this._text_45 = t2;
        t1.appendChild(t2);
        this._el_46 = S.createAndAppend(doc, "hr", parentRenderNode);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_47 = t2;
        J.setAttribute$2$x(t2, "id", "happy-birthday2");
        t2 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._el_48 = t2;
        t2.appendChild(doc.createTextNode("Hero Birthday v2"));
        t2 = A.ViewHeroBirthday2Component0$(this, 50);
        this._compView_50 = t2;
        t2 = t2.rootEl;
        this._el_50 = t2;
        parentRenderNode.appendChild(t2);
        t1 = new Q.HeroBirthday2Component(new P.DateTime(H.checkInt(H.Primitives_valueFromDecomposedDate(1988, 4, 15, 0, 0, 0, 0, false)), false), true);
        this._HeroBirthday2Component_50_4 = t1;
        t2 = this._compView_50;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        this._el_51 = S.createAndAppend(doc, "hr", parentRenderNode);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_52 = t2;
        J.setAttribute$2$x(t2, "id", "birthday-pipe-chaining");
        t2 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._el_53 = t2;
        t2.appendChild(doc.createTextNode("Birthday Pipe Chaining"));
        t2 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_55 = t2;
        t1 = doc.createTextNode("");
        this._text_56 = t1;
        ...
        this._text_60 = t1;
        t2.appendChild(t1);
        this._el_61 = S.createAndAppend(doc, "hr", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_62 = t1;
        J.setAttribute$2$x(t1, "id", "power-booster");
        t1 = U.ViewPowerBoosterComponent0$(this, 63);
        this._compView_63 = t1;
        t1 = t1.rootEl;
        this._el_63 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new K.PowerBoosterComponent();
        this._PowerBoosterComponent_63_4 = t1;
        t2 = this._compView_63;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        this._el_64 = S.createAndAppend(doc, "hr", parentRenderNode);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_65 = t2;
        J.setAttribute$2$x(t2, "id", "power-boost-calc");
        t2 = A.ViewPowerBoostCalculatorComponent0$(this, 66);
        this._compView_66 = t2;
        t2 = t2.rootEl;
        this._el_66 = t2;
        parentRenderNode.appendChild(t2);
        t2 = new F.PowerBoostCalculatorComponent(5, 1);
        this._PowerBoostCalculatorComponent_66_4 = t2;
        t1 = this._compView_66;
        t1.ctx = t2;
        t1.viewData.projectableNodes = [];
        t1.build$0();
        this._el_67 = S.createAndAppend(doc, "hr", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_68 = t1;
        J.setAttribute$2$x(t1, "id", "flying-heroes");
        t1 = M.ViewFlyingHeroesComponent0$(this, 69);
        this._compView_69 = t1;
        t1 = t1.rootEl;
        this._el_69 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new K.FlyingHeroesComponent(null, true, true, "Flying Heroes (pure pipe)");
        t2 = T.Hero;
        t1.heroes = P.List_List$from(C.List_6L0, true, t2);
        this._FlyingHeroesComponent_69_4 = t1;
        t3 = this._compView_69;
        t3.ctx = t1;
        t3.viewData.projectableNodes = [];
        t3.build$0();
        this._el_70 = S.createAndAppend(doc, "hr", parentRenderNode);
        t3 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_71 = t3;
        J.setAttribute$2$x(t3, "id", "flying-heroes-impure");
        t3 = M.ViewFlyingHeroesImpureComponent0$(this, 72);
        this._compView_72 = t3;
        t3 = t3.rootEl;
        this._el_72 = t3;
        parentRenderNode.appendChild(t3);
        t3 = new K.FlyingHeroesImpureComponent(null, true, true, "Flying Heroes (pure pipe)");
        t3.heroes = P.List_List$from(C.List_6L0, true, t2);
        t3.title = "Flying Heroes (impure pipe)";
        this._FlyingHeroesImpureComponent_72_4 = t3;
        t2 = this._compView_72;
        t2.ctx = t3;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        this._el_73 = S.createAndAppend(doc, "hr", parentRenderNode);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_74 = t2;
        J.setAttribute$2$x(t2, "id", "hero-message");
        t2 = F.ViewHeroAsyncMessageComponent0$(this, 75);
        this._compView_75 = t2;
        t2 = t2.rootEl;
        this._el_75 = t2;
        parentRenderNode.appendChild(t2);
        t2 = new K.HeroAsyncMessageComponent(null, H.setRuntimeTypeInfo(["You are my hero!", "You are the best hero!", "Will you be my hero?"], [P.String]));
        t2.resend$0();
        this._HeroAsyncMessageComponent_75_4 = t2;
        t3 = this._compView_75;
        t3.ctx = t2;
        t3.viewData.projectableNodes = [];
        t3.build$0();
        this._el_76 = S.createAndAppend(doc, "hr", parentRenderNode);
        t3 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_77 = t3;
        J.setAttribute$2$x(t3, "id", "hero-list");
        t3 = E.ViewHeroListComponent0$(this, 78);
        this._compView_78 = t3;
        t3 = t3.rootEl;
        this._el_78 = t3;
        parentRenderNode.appendChild(t3);
        t3 = new T.HeroListComponent();
        this._HeroListComponent_78_4 = t3;
        t2 = this._compView_78;
        t2.ctx = t3;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_79 = t2;
        J.setAttribute$2$x(t2, "style", "margin-top:12em;");
        t2 = new R.DatePipe();
        this._app_component_template$_pipe_date_0 = t2;
        t2 = t2.get$transform(t2);
        this._app_component_template$_pipe_date_0_0 = Q.pureProxy1(t2);
        this._pipe_date_0_1 = Q.pureProxy2(t2);
        this._pipe_date_0_2 = Q.pureProxy1(t2);
        this._pipe_date_0_3 = Q.pureProxy2(t2);
        this._pipe_date_0_4 = Q.pureProxy2(t2);
        t2 = new B.UpperCasePipe();
        this._pipe_uppercase_1 = t2;
        t2 = t2.get$transform(t2);
        this._pipe_uppercase_1_0 = Q.pureProxy1(t2);
        this._pipe_uppercase_1_1 = Q.pureProxy1(t2);
        this._pipe_uppercase_1_2 = Q.pureProxy1(t2);
        this.init$2(C.List_empty, null);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroBirthdayComponent_AC0 && 37 === nodeIndex)
          return this._HeroBirthdayComponent_37_4;
        if (token === C.Type_HeroBirthday2Component_Feh && 50 === nodeIndex)
          return this._HeroBirthday2Component_50_4;
        if (token === C.Type_PowerBoosterComponent_TfG && 63 === nodeIndex)
          return this._PowerBoosterComponent_63_4;
        if (token === C.Type_VCV && 66 === nodeIndex)
          return this._PowerBoostCalculatorComponent_66_4;
        if (token === C.Type_FlyingHeroesComponent_0 && 69 === nodeIndex)
          return this._FlyingHeroesComponent_69_4;
        if (token === C.Type_FlyingHeroesImpureComponent_cWY && 72 === nodeIndex)
          return this._FlyingHeroesImpureComponent_72_4;
        if (token === C.Type_HeroAsyncMessageComponent_9nO && 75 === nodeIndex)
          return this._HeroAsyncMessageComponent_75_4;
        if (token === C.Type_HeroListComponent_S3C && 78 === nodeIndex)
          return this._HeroListComponent_78_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, t1, currVal_0, currVal_1, currVal_2, currVal_3, currVal_4;
        _ctx = this.ctx;
        t1 = _ctx.get$birthday();
        t1 = this._app_component_template$_pipe_date_0_0.call$1(t1);
        currVal_0 = "The hero's birthday is " + (t1 == null ? "" : H.S(t1));
        if (this._expr_0 !== currVal_0) {
          this._text_43.textContent = currVal_0;
          this._expr_0 = currVal_0;
        }
        t1 = _ctx.get$birthday();
        t1 = this._pipe_date_0_1.call$2(t1, "MM/dd/yy");
        currVal_1 = "The hero's birthday is " + (t1 == null ? "" : H.S(t1)) + " ";
        if (this._expr_1 !== currVal_1) {
          this._text_45.textContent = currVal_1;
          this._expr_1 = currVal_1;
        }
        t1 = _ctx.get$birthday();
        t1 = this._pipe_date_0_2.call$1(t1);
        t1 = this._pipe_uppercase_1_0.call$1(t1);
        currVal_2 = "The chained hero's birthday is  " + (t1 == null ? "" : H.S(t1));
        if (this._expr_2 !== currVal_2) {
          this._text_56.textContent = currVal_2;
          this._expr_2 = currVal_2;
        }
        t1 = _ctx.get$birthday();
        t1 = this._pipe_date_0_3.call$2(t1, "fullDate");
        t1 = this._pipe_uppercase_1_1.call$1(t1);
        currVal_3 = "The chained hero's birthday is  " + (t1 == null ? "" : H.S(t1));
        if (this._expr_3 !== currVal_3) {
          this._text_58.textContent = currVal_3;
          this._expr_3 = currVal_3;
        }
        t1 = _ctx.get$birthday();
        t1 = this._pipe_date_0_4.call$2(t1, "fullDate");
        t1 = this._pipe_uppercase_1_2.call$1(t1);
        currVal_4 = "The chained hero's birthday is  " + (t1 == null ? "" : H.S(t1));
        if (this._expr_4 !== currVal_4) {
          this._text_60.textContent = currVal_4;
        ...
        this._compView_72.detectChanges$0();
        this._compView_75.detectChanges$0();
        this._compView_78.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._compView_37;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_50;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_63;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_66;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_69;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_72;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_75;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_78;
        if (!(t1 == null))
          t1.destroy$0();
      }
    },
    _ViewAppComponentHost0: {
      ...
      build$0: function() {
        var t1, t2, t3;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), this, null, null, null);
        ...
        t1 = new Q.AppComponent(new P.DateTime(H.checkInt(H.Primitives_valueFromDecomposedDate(1988, 4, 15, 0, 0, 0, 0, false)), false));
  ...
  }], ["", "package:pipe_examples/src/exponential_strength_pipe.dart",, M, {
    "^": "",
    ExponentialStrengthPipe: {
      "^": "PipeTransform;",
      transform$2: [function(_, value, exponent) {
        var t1, t2;
        t1 = value == null ? 0 : value;
        t2 = exponent == null ? 1 : exponent;
        H.checkNum(t1);
        H.checkNum(t2);
        return Math.pow(t1, t2);
      }, "call$2", "get$transform", 4, 0, 66]
    }
  }], ["", "package:pipe_examples/src/exponential_strength_pipe.template.dart",, L, {
    "^": "",
  ...
  }], ["", "package:pipe_examples/src/fetch_json_pipe.dart",, L, {
    "^": "",
    FetchJsonPipe: {
      "^": "PipeTransform;_cachedData,_cachedUrl",
      transform$1: function(_, url) {
        if (url !== this._cachedUrl) {
          this._cachedUrl = url;
          this._cachedData = null;
          W.HttpRequest_getString(url, null, null).then$1(new L.FetchJsonPipe_transform_closure(this));
        }
        return this._cachedData;
      }
    },
    FetchJsonPipe_transform_closure: {
      "^": "Closure:1;$this",
      call$1: [function(s) {
        this.$this._cachedData = C.JsonCodec_null_null.decode$1(s);
      }, null, null, 2, 0, null, 43, "call"]
    }
  }], ["", "package:pipe_examples/src/fetch_json_pipe.template.dart",, K, {
    "^": "",
  ...
  }], ["", "package:pipe_examples/src/flying_heroes_component.dart",, K, {
    "^": "",
    FlyingHeroesComponent: {
      "^": "Object;heroes<,canFly@,mutate@,title>",
      addHero$1: function($name) {
        var hero, t1, t2;
        $name = J.trim$0$s($name);
        if ($name.length === 0)
          return;
        hero = new T.Hero($name, this.canFly);
        t1 = this.mutate;
        t2 = this.heroes;
        if (t1 === true)
          (t2 && C.JSArray_methods).add$1(t2, hero);
        else {
          t1 = P.List_List$from(t2, true, T.Hero);
          C.JSArray_methods.add$1(t1, hero);
          this.heroes = t1;
        }
      },
      reset$0: [function(_) {
        this.heroes = P.List_List$from(C.List_6L0, true, T.Hero);
      }, "call$0", "get$reset", 0, 0, 2]
    },
    FlyingHeroesImpureComponent: {
      "^": "FlyingHeroesComponent;heroes,canFly,mutate,title"
    }
  }], ["", "package:pipe_examples/src/flying_heroes_component.template.dart",, M, {
    "^": "",
    viewFactory_FlyingHeroesComponent1: [function(parentView, parentIndex) {
      var t1 = new M._ViewFlyingHeroesComponent1(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewFlyingHeroesComponent0__renderType;
      return t1;
    }, "call$2", "flying_heroes_component_template__viewFactory_FlyingHeroesComponent1$closure", 4, 0, 24],
    viewFactory_FlyingHeroesComponent2: [function(parentView, parentIndex) {
      var t1 = new M._ViewFlyingHeroesComponent2(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewFlyingHeroesComponent0__renderType;
      return t1;
    }, "call$2", "flying_heroes_component_template__viewFactory_FlyingHeroesComponent2$closure", 4, 0, 24],
    viewFactory_FlyingHeroesComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewFlyingHeroesComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "flying_heroes_component_template__viewFactory_FlyingHeroesComponentHost0$closure", 4, 0, 5],
    viewFactory_FlyingHeroesImpureComponent1: [function(parentView, parentIndex) {
      var t1 = new M._ViewFlyingHeroesImpureComponent1(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewFlyingHeroesImpureComponent0__renderType;
      return t1;
    }, "call$2", "flying_heroes_component_template__viewFactory_FlyingHeroesImpureComponent1$closure", 4, 0, 13],
    viewFactory_FlyingHeroesImpureComponent2: [function(parentView, parentIndex) {
      var t1 = new M._ViewFlyingHeroesImpureComponent2(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewFlyingHeroesImpureComponent0__renderType;
      return t1;
    }, "call$2", "flying_heroes_component_template__viewFactory_FlyingHeroesImpureComponent2$closure", 4, 0, 13],
    viewFactory_FlyingHeroesImpureComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewFlyingHeroesImpureComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "flying_heroes_component_template__viewFactory_FlyingHeroesImpureComponentHost0$closure", 4, 0, 5],
    initReflector2: function() {
      ...
      t1.$indexSet(0, C.Type_FlyingHeroesComponent_0, C.ComponentFactory_A4F);
      t1.$indexSet(0, C.Type_FlyingHeroesImpureComponent_cWY, C.ComponentFactory_ckG);
    },
    ViewFlyingHeroesComponent0: {
      "^": "AppView;_el_0,_text_1,_el_2,_el_4,_el_5,_CheckboxControlValueAccessor_5_4,_NgValueAccessor_5_5,_NgModel_5_6,_el_7,_el_8,_CheckboxControlValueAccessor_8_4,_NgValueAccessor_8_5,_NgModel_8_6,_el_10,_el_12,_el_14,_appEl_15,_NgFor_15_7,_el_16,_el_18,_appEl_19,_NgFor_19_7,_flying_heroes_component_template$_expr_0,_flying_heroes_component_template$_expr_3,_flying_heroes_component_template$_expr_4,_pipe_flyingHeroes_0,_pipe_flyingHeroes_0_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewFlyingHeroesComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("flying-heroes");
        this.rootEl = t1;
        t1 = $.ViewFlyingHeroesComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_4QF);
          $.ViewFlyingHeroesComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_3, t2, _text_6, _text_9, _text_11, _text_13, _anchor_15, _text_17, _anchor_19, subscription_0, subscription_1;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._el_0 = t1;
        ...
        this._el_2 = t1;
        this.addShimE$1(t1);
        _text_3 = doc.createTextNode("New hero:");
        this._el_2.appendChild(_text_3);
        t1 = S.createAndAppend(doc, "input", this._el_2);
        this._el_4 = t1;
        J.setAttribute$2$x(t1, "placeholder", "hero name");
        J.setAttribute$2$x(this._el_4, "type", "text");
        this.addShimC$1(this._el_4);
        t1 = S.createAndAppend(doc, "input", this._el_2);
        this._el_5 = t1;
        J.setAttribute$2$x(t1, "id", "can-fly");
        J.setAttribute$2$x(this._el_5, "type", "checkbox");
        this.addShimC$1(this._el_5);
        t1 = new N.CheckboxControlValueAccessor(this._el_5, new N.closure0(), new N.closure1());
        this._CheckboxControlValueAccessor_5_4 = t1;
        t1 = [t1];
        this._NgValueAccessor_5_5 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._NgModel_5_6 = t2;
        _text_6 = doc.createTextNode("can fly");
        this._el_2.appendChild(_text_6);
        t2 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_7 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "input", this._el_7);
        this._el_8 = t2;
        J.setAttribute$2$x(t2, "id", "mutate");
        J.setAttribute$2$x(this._el_8, "type", "checkbox");
        this.addShimC$1(this._el_8);
        t2 = new N.CheckboxControlValueAccessor(this._el_8, new N.closure0(), new N.closure1());
        this._CheckboxControlValueAccessor_8_4 = t2;
        t2 = [t2];
        this._NgValueAccessor_8_5 = t2;
        t1 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t1._init$1(t2);
        this._NgModel_8_6 = t1;
        _text_9 = doc.createTextNode("Mutate array");
        this._el_7.appendChild(_text_9);
        t1 = S.createAndAppend(doc, "button", this._el_7);
        this._el_10 = t1;
        this.addShimC$1(t1);
        _text_11 = doc.createTextNode("Reset");
        this._el_10.appendChild(_text_11);
        t1 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_12 = t1;
        this.addShimE$1(t1);
        _text_13 = doc.createTextNode("Heroes who fly (piped)");
        this._el_12.appendChild(_text_13);
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_14 = t1;
        J.setAttribute$2$x(t1, "id", "flyers");
        this.addShimC$1(this._el_14);
        t1 = $.$get$ngAnchor();
        _anchor_15 = t1.cloneNode(false);
        this._el_14.appendChild(_anchor_15);
        t2 = new V.ViewContainer(15, 14, this, _anchor_15, null, null, null);
        this._appEl_15 = t2;
        this._NgFor_15_7 = new R.NgFor(t2, null, null, null, new D.TemplateRef(t2, M.flying_heroes_component_template__viewFactory_FlyingHeroesComponent1$closure()));
        t2 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_16 = t2;
        this.addShimE$1(t2);
        _text_17 = doc.createTextNode("All Heroes (no pipe)");
        this._el_16.appendChild(_text_17);
        t2 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_18 = t2;
        J.setAttribute$2$x(t2, "id", "all");
        this.addShimC$1(this._el_18);
        _anchor_19 = t1.cloneNode(false);
        this._el_18.appendChild(_anchor_19);
        t1 = new V.ViewContainer(19, 18, this, _anchor_19, null, null, null);
        this._appEl_19 = t1;
        this._NgFor_19_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, M.flying_heroes_component_template__viewFactory_FlyingHeroesComponent2$closure()));
        J.addEventListener$3$x($.appViewUtils.get$eventManager(), this._el_4, "keyup.enter", this.eventHandler1$1(this.get$_handle_keyup_enter_4_0()));
        J._addEventListener$3$x(this._el_5, "change", this.eventHandler1$1(this.get$_handle_change_5_1()), null);
        J._addEventListener$3$x(this._el_5, "blur", this.eventHandler0$1(this._CheckboxControlValueAccessor_5_4.get$touchHandler()), null);
        t1 = this._NgModel_5_6._update;
        t1.toString;
        ...
        J._addEventListener$3$x(this._el_8, "change", this.eventHandler1$1(this.get$_handle_change_8_1()), null);
        J._addEventListener$3$x(this._el_8, "blur", this.eventHandler0$1(this._CheckboxControlValueAccessor_8_4.get$touchHandler()), null);
        t1 = this._NgModel_8_6._update;
        t1.toString;
        ...
        J._addEventListener$3$x(this._el_10, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        t1 = new N.FlyingHeroesPipe();
        this._pipe_flyingHeroes_0 = t1;
        this._pipe_flyingHeroes_0_0 = Q.pureProxy1(t1.get$transform(t1));
        this.init$2(C.List_empty, [subscription_0, subscription_1]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        var t1, t2, t3;
        t1 = token === C.Type_CheckboxControlValueAccessor_VUq;
        if (t1 && 5 === nodeIndex)
          return this._CheckboxControlValueAccessor_5_4;
        t2 = token === C.OpaqueToken_NgValueAccessor;
        if (t2 && 5 === nodeIndex)
          return this._NgValueAccessor_5_5;
        t3 = token !== C.Type_NgModel_qx4;
        if ((!t3 || token === C.Type_NgControl_GNi) && 5 === nodeIndex)
          return this._NgModel_5_6;
        if (t1 && 8 === nodeIndex)
          return this._CheckboxControlValueAccessor_8_4;
        if (t2 && 8 === nodeIndex)
          return this._NgValueAccessor_8_5;
        if ((!t3 || token === C.Type_NgControl_GNi) && 8 === nodeIndex)
          return this._NgModel_8_6;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        ...
        this._NgModel_5_6.set$model(_ctx.get$canFly());
        this._NgModel_5_6.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_5_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        this._NgModel_8_6.set$model(_ctx.get$mutate());
        this._NgModel_8_6.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_8_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        t1 = _ctx.get$heroes();
        currVal_3 = this._pipe_flyingHeroes_0_0.call$1(t1);
        t1 = this._flying_heroes_component_template$_expr_3;
        if (t1 == null ? currVal_3 != null : t1 !== currVal_3) {
          this._NgFor_15_7.set$ngForOf(currVal_3);
          this._flying_heroes_component_template$_expr_3 = currVal_3;
        }
        this._NgFor_15_7.ngDoCheck$0();
        currVal_4 = _ctx.get$heroes();
        t1 = this._flying_heroes_component_template$_expr_4;
        if (t1 == null ? currVal_4 != null : t1 !== currVal_4) {
          this._NgFor_19_7.set$ngForOf(currVal_4);
          this._flying_heroes_component_template$_expr_4 = currVal_4;
        }
        this._NgFor_19_7.ngDoCheck$0();
        this._appEl_15.detectChangesInNestedViews$0();
        this._appEl_19.detectChangesInNestedViews$0();
        currVal_0 = J.get$title$x(_ctx);
        if (currVal_0 == null)
          currVal_0 = "";
        if (this._flying_heroes_component_template$_expr_0 !== currVal_0) {
          this._text_1.textContent = currVal_0;
          this._flying_heroes_component_template$_expr_0 = currVal_0;
        }
      },
      destroyInternal$0: function() {
        var t1 = this._appEl_15;
        if (!(t1 == null))
      ...
      _handle_keyup_enter_4_0$1: [function($$event) {
        var local_box, t1;
        local_box = this._el_4;
        t1 = J.getInterceptor$x(local_box);
        this.ctx.addHero$1(t1.get$value(local_box));
        t1.set$value(local_box, "");
      }, "call$1", "get$_handle_keyup_enter_4_0", 2, 0, 3],
      _handle_ngModelChange_5_0$1: [function($$event) {
        this.ctx.set$canFly($$event);
      }, "call$1", "get$_handle_ngModelChange_5_0", 2, 0, 3],
      _handle_change_5_1$1: [function($$event) {
        var t1, t2;
        t1 = this._CheckboxControlValueAccessor_5_4;
        t2 = J.get$checked$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_change_5_1", 2, 0, 3],
      _handle_ngModelChange_8_0$1: [function($$event) {
        this.ctx.set$mutate($$event);
      }, "call$1", "get$_handle_ngModelChange_8_0", 2, 0, 3],
      _handle_change_8_1$1: [function($$event) {
        var t1, t2;
        t1 = this._CheckboxControlValueAccessor_8_4;
        t2 = J.get$checked$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_change_8_1", 2, 0, 3],
      static: {
        ViewFlyingHeroesComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewFlyingHeroesComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewFlyingHeroesComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewFlyingHeroesComponent1: {
      "^": "AppView;_el_0,_text_1,_flying_heroes_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
    ...
    _ViewFlyingHeroesComponentHost0: {
      "^": "AppView;_compView_0,_FlyingHeroesComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = M.ViewFlyingHeroesComponent0$(this, 0);
        this._compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new K.FlyingHeroesComponent(null, true, true, "Flying Heroes (pure pipe)");
        t1.heroes = P.List_List$from(C.List_6L0, true, T.Hero);
        this._FlyingHeroesComponent_0_4 = t1;
        t2 = this._compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._FlyingHeroesComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_FlyingHeroesComponent_0 && 0 === nodeIndex)
          return this._FlyingHeroesComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
    ...
    ViewFlyingHeroesImpureComponent0: {
      "^": "AppView;_el_0,_text_1,_el_2,_el_4,_el_5,_CheckboxControlValueAccessor_5_4,_NgValueAccessor_5_5,_NgModel_5_6,_el_7,_el_8,_CheckboxControlValueAccessor_8_4,_NgValueAccessor_8_5,_NgModel_8_6,_el_10,_el_12,_el_14,_appEl_15,_NgFor_15_7,_el_16,_el_18,_appEl_19,_NgFor_19_7,_flying_heroes_component_template$_expr_0,_flying_heroes_component_template$_expr_3,_flying_heroes_component_template$_expr_4,_pipe_flyingHeroes_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewFlyingHeroesImpureComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("flying-heroes-impure");
        this.rootEl = t1;
        t1 = $.ViewFlyingHeroesImpureComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_MDg);
          $.ViewFlyingHeroesImpureComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        t2 = new V.ViewContainer(15, 14, this, _anchor_15, null, null, null);
        this._appEl_15 = t2;
        this._NgFor_15_7 = new R.NgFor(t2, null, null, null, new D.TemplateRef(t2, M.flying_heroes_component_template__viewFactory_FlyingHeroesImpureComponent1$closure()));
        t2 = S.createAndAppend(doc, "h4", parentRenderNode);
        this._el_16 = t2;
        this.addShimE$1(t2);
        _text_17 = doc.createTextNode("All Heroes (no pipe)");
        ...
        t1 = new V.ViewContainer(19, 18, this, _anchor_19, null, null, null);
        this._appEl_19 = t1;
        this._NgFor_19_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, M.flying_heroes_component_template__viewFactory_FlyingHeroesImpureComponent2$closure()));
        J.addEventListener$3$x($.appViewUtils.get$eventManager(), this._el_4, "keyup.enter", this.eventHandler1$1(this.get$_handle_keyup_enter_4_0()));
        J._addEventListener$3$x(this._el_5, "change", this.eventHandler1$1(this.get$_handle_change_5_1()), null);
        J._addEventListener$3$x(this._el_5, "blur", this.eventHandler0$1(this._CheckboxControlValueAccessor_5_4.get$touchHandler()), null);
        t1 = this._NgModel_5_6._update;
        ...
        subscription_1 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_8_0()));
        J._addEventListener$3$x(this._el_10, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        this._pipe_flyingHeroes_0 = new N.FlyingHeroesImpurePipe();
        this.init$2(C.List_empty, [subscription_0, subscription_1]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
      ...
      detectChangesInternal$0: function() {
        ...
        currVal_3 = this._pipe_flyingHeroes_0.transform$1(0, _ctx.get$heroes());
        if (this._flying_heroes_component_template$_expr_3 !== currVal_3) {
          this._NgFor_15_7.set$ngForOf(currVal_3);
          this._flying_heroes_component_template$_expr_3 = currVal_3;
        }
        this._NgFor_15_7.ngDoCheck$0();
        ...
        this._appEl_15.detectChangesInNestedViews$0();
        this._appEl_19.detectChangesInNestedViews$0();
        currVal_0 = Q.interpolate0(J.get$title$x(_ctx));
        if (this._flying_heroes_component_template$_expr_0 !== currVal_0) {
          this._text_1.textContent = currVal_0;
          this._flying_heroes_component_template$_expr_0 = currVal_0;
        }
      ...
      static: {
        ViewFlyingHeroesImpureComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewFlyingHeroesImpureComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewFlyingHeroesImpureComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewFlyingHeroesImpureComponent1: {
      "^": "AppView;_el_0,_text_1,_flying_heroes_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
    ...
    _ViewFlyingHeroesImpureComponent2: {
      "^": "AppView;_el_0,_text_1,_flying_heroes_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
    ...
    _ViewFlyingHeroesImpureComponentHost0: {
      "^": "AppView;_compView_0,_FlyingHeroesImpureComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = M.ViewFlyingHeroesImpureComponent0$(this, 0);
        this._compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new K.FlyingHeroesImpureComponent(null, true, true, "Flying Heroes (pure pipe)");
        t1.heroes = P.List_List$from(C.List_6L0, true, T.Hero);
        t1.title = "Flying Heroes (impure pipe)";
        this._FlyingHeroesImpureComponent_0_4 = t1;
        t2 = this._compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._FlyingHeroesImpureComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_FlyingHeroesImpureComponent_cWY && 0 === nodeIndex)
          return this._FlyingHeroesImpureComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._compView_0.detectChanges$0();
  ...
  }], ["", "package:pipe_examples/src/flying_heroes_pipe.dart",, N, {
    "^": "",
    FlyingHeroesPipe: {
      "^": "PipeTransform;",
      transform$1: [function(_, value) {
        return J.where$1$ax(value, new N.FlyingHeroesPipe_transform_closure()).toList$0(0);
      }, "call$1", "get$transform", 2, 0, 68]
    },
    FlyingHeroesPipe_transform_closure: {
      "^": "Closure:1;",
      call$1: function(hero) {
        return hero.get$canFly();
      }
    },
    FlyingHeroesImpurePipe: {
      "^": "FlyingHeroesPipe;"
    }
  }], ["", "package:pipe_examples/src/flying_heroes_pipe.template.dart",, S, {
    "^": "",
  ...
  }], ["", "package:pipe_examples/src/hero_async_message_component.dart",, K, {
    "^": "",
    HeroAsyncMessageComponent: {
      "^": "Object;message>,_msgs",
      resend$0: [function() {
        var t1 = P.Stream_Stream$periodic(C.Duration_500000, new K.HeroAsyncMessageComponent_resend_closure(this), null);
        this.message = new P._TakeStream(3, t1, [H.getTypeArgumentByIndex(t1, 0)]);
      }, "call$0", "get$resend", 0, 0, 2]
    },
    HeroAsyncMessageComponent_resend_closure: {
      "^": "Closure:1;$this",
      call$1: function(i) {
        var t1 = this.$this._msgs;
        if (i >= 3)
          return H.ioore(t1, i);
        return t1[i];
      }
    }
  }], ["", "package:pipe_examples/src/hero_async_message_component.template.dart",, F, {
    "^": "",
    viewFactory_HeroAsyncMessageComponentHost0: [function(parentView, parentIndex) {
      var t1 = new F._ViewHeroAsyncMessageComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "hero_async_message_component_template__viewFactory_HeroAsyncMessageComponentHost0$closure", 4, 0, 5],
    initReflector3: function() {
      if ($._visited33)
        return;
      $._visited33 = true;
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_HeroAsyncMessageComponent_9nO, C.ComponentFactory_oyU);
    },
    ViewHeroAsyncMessageComponent0: {
      "^": "AppView;_hero_async_message_component_template$_el_0,_hero_async_message_component_template$_el_2,_text_3,_hero_async_message_component_template$_el_4,_hero_async_message_component_template$_expr_0,_pipe_async_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroAsyncMessageComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-message");
        this.rootEl = t1;
        t1 = $.ViewHeroAsyncMessageComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewHeroAsyncMessageComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        doc = document;
        t1 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._hero_async_message_component_template$_el_0 = t1;
        t1.appendChild(doc.createTextNode("Async Hero Message and AsyncPipe"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._hero_async_message_component_template$_el_2 = t1;
        t2 = doc.createTextNode("");
        this._text_3 = t2;
        t1.appendChild(t2);
        t2 = S.createAndAppend(doc, "button", parentRenderNode);
        this._hero_async_message_component_template$_el_4 = t2;
        t2.appendChild(doc.createTextNode("Resend"));
        J._addEventListener$3$x(this._hero_async_message_component_template$_el_4, "click", this.eventHandler0$1(this.ctx.get$resend()), null);
      ...
      detectChangesInternal$0: function() {
        ...
        _ctx = this.ctx;
        t1 = this._pipe_async_0.transform$1(0, J.get$message$x(_ctx));
        currVal_0 = "Message: " + (t1 == null ? "" : H.S(t1));
        if (this._hero_async_message_component_template$_expr_0 !== currVal_0) {
          this._text_3.textContent = currVal_0;
          this._hero_async_message_component_template$_expr_0 = currVal_0;
        }
      },
      destroyInternal$0: function() {
        var t1 = this._pipe_async_0;
        if (t1._async_pipe$_subscription != null)
          t1._dispose$0();
      },
      static: {
        ViewHeroAsyncMessageComponent0$: function(parentView, parentIndex) {
          var t1 = new F.ViewHeroAsyncMessageComponent0(null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewHeroAsyncMessageComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroAsyncMessageComponentHost0: {
      "^": "AppView;_hero_async_message_component_template$_compView_0,_HeroAsyncMessageComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = F.ViewHeroAsyncMessageComponent0$(this, 0);
        this._hero_async_message_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new K.HeroAsyncMessageComponent(null, H.setRuntimeTypeInfo(["You are my hero!", "You are the best hero!", "Will you be my hero?"], [P.String]));
        t1.resend$0();
        this._HeroAsyncMessageComponent_0_4 = t1;
        t2 = this._hero_async_message_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroAsyncMessageComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroAsyncMessageComponent_9nO && 0 === nodeIndex)
          return this._HeroAsyncMessageComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_async_message_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_async_message_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  }], ["", "package:pipe_examples/src/hero_birthday1_component.dart",, U, {
    "^": "",
    HeroBirthdayComponent: {
      "^": "Object;birthday<"
    }
  }], ["", "package:pipe_examples/src/hero_birthday1_component.template.dart",, G, {
    "^": "",
    viewFactory_HeroBirthdayComponentHost0: [function(parentView, parentIndex) {
      var t1 = new G._ViewHeroBirthdayComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "hero_birthday1_component_template__viewFactory_HeroBirthdayComponentHost0$closure", 4, 0, 5],
    initReflector4: function() {
      if ($._visited32)
        return;
      $._visited32 = true;
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_HeroBirthdayComponent_AC0, C.ComponentFactory_2Vk);
    },
    ViewHeroBirthdayComponent0: {
      "^": "AppView;_hero_birthday1_component_template$_el_0,_hero_birthday1_component_template$_text_1,_hero_birthday1_component_template$_expr_0,_pipe_date_0,_pipe_date_0_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroBirthdayComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-birthday");
        this.rootEl = t1;
        t1 = $.ViewHeroBirthdayComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewHeroBirthdayComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        doc = document;
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._hero_birthday1_component_template$_el_0 = t1;
        t2 = doc.createTextNode("");
        this._hero_birthday1_component_template$_text_1 = t2;
        t1.appendChild(t2);
        t2 = new R.DatePipe();
        this._pipe_date_0 = t2;
        this._pipe_date_0_0 = Q.pureProxy1(t2.get$transform(t2));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var t1, currVal_0;
        t1 = this.ctx.get$birthday();
        t1 = this._pipe_date_0_0.call$1(t1);
        currVal_0 = "The hero's birthday is " + (t1 == null ? "" : H.S(t1));
        if (this._hero_birthday1_component_template$_expr_0 !== currVal_0) {
          this._hero_birthday1_component_template$_text_1.textContent = currVal_0;
          this._hero_birthday1_component_template$_expr_0 = currVal_0;
        }
      },
      static: {
        ViewHeroBirthdayComponent0$: function(parentView, parentIndex) {
          var t1 = new G.ViewHeroBirthdayComponent0(null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewHeroBirthdayComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroBirthdayComponentHost0: {
      "^": "AppView;_hero_birthday1_component_template$_compView_0,_HeroBirthdayComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = G.ViewHeroBirthdayComponent0$(this, 0);
        this._hero_birthday1_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new U.HeroBirthdayComponent(new P.DateTime(H.checkInt(H.Primitives_valueFromDecomposedDate(1988, 4, 15, 0, 0, 0, 0, false)), false));
        this._HeroBirthdayComponent_0_4 = t1;
        t2 = this._hero_birthday1_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroBirthdayComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroBirthdayComponent_AC0 && 0 === nodeIndex)
          return this._HeroBirthdayComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_birthday1_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_birthday1_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  }], ["", "package:pipe_examples/src/hero_birthday2_component.dart",, Q, {
    "^": "",
    HeroBirthday2Component: {
      "^": "Object;birthday<,toggle",
      get$format: function() {
        return this.toggle ? "shortDate" : "fullDate";
      },
      toggleFormat$0: [function() {
        this.toggle = !this.toggle;
      }, "call$0", "get$toggleFormat", 0, 0, 2],
      format$1: function(arg0) {
        return this.get$format().call$1(arg0);
      }
    }
  }], ["", "package:pipe_examples/src/hero_birthday2_component.template.dart",, A, {
    "^": "",
    viewFactory_HeroBirthday2ComponentHost0: [function(parentView, parentIndex) {
      var t1 = new A._ViewHeroBirthday2ComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "hero_birthday2_component_template__viewFactory_HeroBirthday2ComponentHost0$closure", 4, 0, 5],
    initReflector5: function() {
      if ($._visited31)
        return;
      $._visited31 = true;
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_HeroBirthday2Component_Feh, C.ComponentFactory_MQk);
    },
    ViewHeroBirthday2Component0: {
      "^": "AppView;_hero_birthday2_component_template$_el_0,_hero_birthday2_component_template$_text_1,_hero_birthday2_component_template$_el_2,_hero_birthday2_component_template$_expr_0,_hero_birthday2_component_template$_pipe_date_0,_hero_birthday2_component_template$_pipe_date_0_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewHeroBirthday2Component0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("hero-birthday2");
        this.rootEl = t1;
        t1 = $.ViewHeroBirthday2Component0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewHeroBirthday2Component0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        doc = document;
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._hero_birthday2_component_template$_el_0 = t1;
        t2 = doc.createTextNode("");
        this._hero_birthday2_component_template$_text_1 = t2;
        t1.appendChild(t2);
        t2 = S.createAndAppend(doc, "button", parentRenderNode);
        this._hero_birthday2_component_template$_el_2 = t2;
        t2.appendChild(doc.createTextNode("Toggle Format"));
        J._addEventListener$3$x(this._hero_birthday2_component_template$_el_2, "click", this.eventHandler0$1(this.ctx.get$toggleFormat()), null);
        t1 = new R.DatePipe();
        this._hero_birthday2_component_template$_pipe_date_0 = t1;
        this._hero_birthday2_component_template$_pipe_date_0_0 = Q.pureProxy2(t1.get$transform(t1));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        ...
        t1 = _ctx.get$birthday();
        t2 = _ctx.get$format();
        t2 = this._hero_birthday2_component_template$_pipe_date_0_0.call$2(t1, t2);
        currVal_0 = "The hero's birthday is " + (t2 == null ? "" : H.S(t2));
        if (this._hero_birthday2_component_template$_expr_0 !== currVal_0) {
          this._hero_birthday2_component_template$_text_1.textContent = currVal_0;
          this._hero_birthday2_component_template$_expr_0 = currVal_0;
        }
      },
      static: {
        ViewHeroBirthday2Component0$: function(parentView, parentIndex) {
          var t1 = new A.ViewHeroBirthday2Component0(null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewHeroBirthday2Component0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewHeroBirthday2ComponentHost0: {
      "^": "AppView;_hero_birthday2_component_template$_compView_0,_HeroBirthday2Component_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = A.ViewHeroBirthday2Component0$(this, 0);
        this._hero_birthday2_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new Q.HeroBirthday2Component(new P.DateTime(H.checkInt(H.Primitives_valueFromDecomposedDate(1988, 4, 15, 0, 0, 0, 0, false)), false), true);
        this._HeroBirthday2Component_0_4 = t1;
        t2 = this._hero_birthday2_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._HeroBirthday2Component_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_HeroBirthday2Component_Feh && 0 === nodeIndex)
          return this._HeroBirthday2Component_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._hero_birthday2_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._hero_birthday2_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  }], ["", "package:pipe_examples/src/hero_list_component.dart",, T, {
    "^": "",
    HeroListComponent: {
      "^": "Object;"
    }
  }], ["", "package:pipe_examples/src/hero_list_component.template.dart",, E, {
    "^": "",
    viewFactory_HeroListComponent1: [function(parentView, parentIndex) {
      ...
      return t1;
    }, "call$2", "hero_list_component_template__viewFactory_HeroListComponent1$closure", 4, 0, 56],
    viewFactory_HeroListComponentHost0: [function(parentView, parentIndex) {
      ...
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "hero_list_component_template__viewFactory_HeroListComponentHost0$closure", 4, 0, 5],
    ...
    ViewHeroListComponent0: {
      "^": "AppView;_hero_list_component_template$_el_0,_appEl_2,_NgFor_2_7,_el_3,_text_4,_hero_list_component_template$_expr_0,_hero_list_component_template$_expr_1,_pipe_fetch_0,_pipe_fetch_1,_pipe_json_2,viewData,locals,parentView,componentType,rootEl,ctx",
      ...
      build$0: function() {
        var parentRenderNode, doc, t1, _anchor_2, t2;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._hero_list_component_template$_el_0 = t1;
        t1.appendChild(doc.createTextNode("Heroes from JSON File"));
        ...
        this._appEl_2 = t1;
        this._NgFor_2_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, E.hero_list_component_template__viewFactory_HeroListComponent1$closure()));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._el_3 = t1;
        t2 = doc.createTextNode("");
        this._text_4 = t2;
        t1.appendChild(t2);
        this._pipe_fetch_0 = new L.FetchJsonPipe(null, null);
        this._pipe_fetch_1 = new L.FetchJsonPipe(null, null);
        this._pipe_json_2 = new L.JsonPipe();
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0, t1, t2, currVal_1;
        currVal_0 = this._pipe_fetch_0.transform$1(0, "heroes.json");
        t1 = this._hero_list_component_template$_expr_0;
        if (t1 == null ? currVal_0 != null : t1 !== currVal_0) {
          this._NgFor_2_7.set$ngForOf(currVal_0);
        ...
        t1 = this._pipe_json_2;
        t2 = this._pipe_fetch_1.transform$1(0, "heroes.json");
        t1.toString;
        t2 = P._JsonStringStringifier_stringify(t2, null, "  ");
        currVal_1 = "Heroes as JSON: " + t2;
        if (this._hero_list_component_template$_expr_1 !== currVal_1) {
          this._text_4.textContent = currVal_1;
          this._hero_list_component_template$_expr_1 = currVal_1;
        }
      },
      destroyInternal$0: function() {
        var t1 = this._appEl_2;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
      },
      static: {
        ViewHeroListComponent0$: function(parentView, parentIndex) {
          var t1 = new E.ViewHeroListComponent0(null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
    ...
    _ViewHeroListComponent1: {
      "^": "AppView;_hero_list_component_template$_el_0,_hero_list_component_template$_text_1,_hero_list_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1, t2;
        doc = document;
        t1 = doc.createElement("div");
        this._hero_list_component_template$_el_0 = t1;
        t2 = doc.createTextNode("");
        this._hero_list_component_template$_text_1 = t2;
        t1.appendChild(t2);
        this.init0$1(this._hero_list_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0 = Q.interpolate0(J.$index$asx(this.locals.$index(0, "$implicit"), "name"));
        if (this._hero_list_component_template$_expr_0 !== currVal_0) {
          this._hero_list_component_template$_text_1.textContent = currVal_0;
          this._hero_list_component_template$_expr_0 = currVal_0;
        }
      }
    },
    _ViewHeroListComponentHost0: {
      ...
      build$0: function() {
        ...
        this.rootEl = t1.rootEl;
        t2 = new T.HeroListComponent();
        this._HeroListComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
  ...
  }], ["", "package:pipe_examples/src/heroes.dart",, T, {
    "^": "",
    Hero: {
      "^": "Object;name>,canFly<",
      toString$0: function(_) {
        var t1 = this.name + " (";
        return t1 + (this.canFly === true ? "can fly" : "doesn't fly") + ")";
      }
    }
  }], ["", "package:pipe_examples/src/power_boost_calculator_component.dart",, F, {
    "^": "",
    PowerBoostCalculatorComponent: {
      "^": "Object;power@,factor@"
    }
  }], ["", "package:pipe_examples/src/power_boost_calculator_component.template.dart",, A, {
    "^": "",
    viewFactory_PowerBoostCalculatorComponentHost0: [function(parentView, parentIndex) {
      var t1 = new A._ViewPowerBoostCalculatorComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "power_boost_calculator_component_template__viewFactory_PowerBoostCalculatorComponentHost0$closure", 4, 0, 5],
    initReflector7: function() {
      ...
      E.initReflector0();
      K.initReflector10();
      $.$get$_components().$indexSet(0, C.Type_VCV, C.ComponentFactory_K13);
    },
    ViewPowerBoostCalculatorComponent0: {
      "^": "AppView;_power_boost_calculator_component_template$_el_0,_power_boost_calculator_component_template$_el_2,_power_boost_calculator_component_template$_el_4,_DefaultValueAccessor_4_4,_NumberValueAccessor_4_5,_NgValueAccessor_4_6,_NgModel_4_7,_power_boost_calculator_component_template$_el_5,_power_boost_calculator_component_template$_el_7,_DefaultValueAccessor_7_4,_NumberValueAccessor_7_5,_NgValueAccessor_7_6,_NgModel_7_7,_power_boost_calculator_component_template$_el_8,_text_9,_power_boost_calculator_component_template$_expr_2,_pipe_exponentialStrength_0,_pipe_exponentialStrength_0_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewPowerBoostCalculatorComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("power-boost-calculator");
        this.rootEl = t1;
        t1 = $.ViewPowerBoostCalculatorComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewPowerBoostCalculatorComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, t2, subscription_0, subscription_1;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._power_boost_calculator_component_template$_el_0 = t1;
        t1.appendChild(doc.createTextNode("Power Boost Calculator"));
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._power_boost_calculator_component_template$_el_2 = t1;
        t1.appendChild(doc.createTextNode("Normal power:"));
        t1 = S.createAndAppend(doc, "input", this._power_boost_calculator_component_template$_el_2);
        this._power_boost_calculator_component_template$_el_4 = t1;
        J.setAttribute$2$x(t1, "type", "number");
        t1 = this._power_boost_calculator_component_template$_el_4;
        t2 = new O.DefaultValueAccessor(t1, new O.closure10(), new O.closure11());
        this._DefaultValueAccessor_4_4 = t2;
        t1 = new O.NumberValueAccessor(t1, new O.closure12(), new O.closure13());
        this._NumberValueAccessor_4_5 = t1;
        t1 = [t2, t1];
        this._NgValueAccessor_4_6 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._NgModel_4_7 = t2;
        t2 = S.createDivAndAppend(doc, parentRenderNode);
        this._power_boost_calculator_component_template$_el_5 = t2;
        t2.appendChild(doc.createTextNode("Boost factor:"));
        t2 = S.createAndAppend(doc, "input", this._power_boost_calculator_component_template$_el_5);
        this._power_boost_calculator_component_template$_el_7 = t2;
        J.setAttribute$2$x(t2, "type", "number");
        t2 = this._power_boost_calculator_component_template$_el_7;
        t1 = new O.DefaultValueAccessor(t2, new O.closure10(), new O.closure11());
        this._DefaultValueAccessor_7_4 = t1;
        t2 = new O.NumberValueAccessor(t2, new O.closure12(), new O.closure13());
        this._NumberValueAccessor_7_5 = t2;
        t2 = [t1, t2];
        this._NgValueAccessor_7_6 = t2;
        t1 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t1._init$1(t2);
        this._NgModel_7_7 = t1;
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._power_boost_calculator_component_template$_el_8 = t1;
        t2 = doc.createTextNode("");
        this._text_9 = t2;
        t1.appendChild(t2);
        J._addEventListener$3$x(this._power_boost_calculator_component_template$_el_4, "input", this.eventHandler1$1(this.get$_handle_input_4_1()), null);
        J._addEventListener$3$x(this._power_boost_calculator_component_template$_el_4, "blur", this.eventHandler1$1(this.get$_handle_blur_4_2()), null);
        J._addEventListener$3$x(this._power_boost_calculator_component_template$_el_4, "change", this.eventHandler1$1(this.get$_handle_change_4_3()), null);
        t1 = this._NgModel_4_7._update;
        t1.toString;
        ...
        J._addEventListener$3$x(this._power_boost_calculator_component_template$_el_7, "input", this.eventHandler1$1(this.get$_handle_input_7_1()), null);
        J._addEventListener$3$x(this._power_boost_calculator_component_template$_el_7, "blur", this.eventHandler1$1(this.get$_handle_blur_7_2()), null);
        J._addEventListener$3$x(this._power_boost_calculator_component_template$_el_7, "change", this.eventHandler1$1(this.get$_handle_change_7_3()), null);
        t1 = this._NgModel_7_7._update;
        t1.toString;
        subscription_1 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_7_0()));
        t1 = new M.ExponentialStrengthPipe();
        this._pipe_exponentialStrength_0 = t1;
        this._pipe_exponentialStrength_0_0 = Q.pureProxy2(t1.get$transform(t1));
        this.init$2(C.List_empty, [subscription_0, subscription_1]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        ...
        t2 = token === C.Type_NumberValueAccessor_qbj;
        if (t2 && 4 === nodeIndex)
          return this._NumberValueAccessor_4_5;
        t3 = token === C.OpaqueToken_NgValueAccessor;
        if (t3 && 4 === nodeIndex)
          return this._NgValueAccessor_4_6;
        t4 = token !== C.Type_NgModel_qx4;
        if ((!t4 || token === C.Type_NgControl_GNi) && 4 === nodeIndex)
          return this._NgModel_4_7;
        if (t1 && 7 === nodeIndex)
          return this._DefaultValueAccessor_7_4;
        if (t2 && 7 === nodeIndex)
          return this._NumberValueAccessor_7_5;
        if (t3 && 7 === nodeIndex)
          return this._NgValueAccessor_7_6;
        if ((!t4 || token === C.Type_NgControl_GNi) && 7 === nodeIndex)
          return this._NgModel_7_7;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, t1, t2, currVal_2;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        this._NgModel_4_7.set$model(_ctx.get$power());
        this._NgModel_4_7.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_4_7;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        this._NgModel_7_7.set$model(_ctx.get$factor());
        this._NgModel_7_7.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_7_7;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        t1 = _ctx.get$power();
        t2 = _ctx.get$factor();
        t2 = this._pipe_exponentialStrength_0_0.call$2(t1, t2);
        currVal_2 = "Super Hero Power: " + (t2 == null ? "" : H.S(t2));
        if (this._power_boost_calculator_component_template$_expr_2 !== currVal_2) {
          this._text_9.textContent = currVal_2;
          this._power_boost_calculator_component_template$_expr_2 = currVal_2;
        }
      },
      _handle_ngModelChange_4_0$1: [function($$event) {
        this.ctx.set$power($$event);
      }, "call$1", "get$_handle_ngModelChange_4_0", 2, 0, 3],
      _handle_input_4_1$1: [function($$event) {
        ...
        t3 = this._NumberValueAccessor_4_5;
        t2 = J.get$value$x(t2.get$target($$event));
        t3.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_4_1", 2, 0, 3],
      _handle_blur_4_2$1: [function($$event) {
        this._DefaultValueAccessor_4_4.onTouched.call$0();
        this._NumberValueAccessor_4_5.onTouched.call$0();
      }, "call$1", "get$_handle_blur_4_2", 2, 0, 3],
      _handle_change_4_3$1: [function($$event) {
        var t1, t2;
        t1 = this._NumberValueAccessor_4_5;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_change_4_3", 2, 0, 3],
      _handle_ngModelChange_7_0$1: [function($$event) {
        this.ctx.set$factor($$event);
      }, "call$1", "get$_handle_ngModelChange_7_0", 2, 0, 3],
      _handle_input_7_1$1: [function($$event) {
        ...
        t3 = J.get$value$x(t2.get$target($$event));
        t1.onChange.call$1(t3);
        t3 = this._NumberValueAccessor_7_5;
        t2 = J.get$value$x(t2.get$target($$event));
        t3.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_7_1", 2, 0, 3],
      _handle_blur_7_2$1: [function($$event) {
        this._DefaultValueAccessor_7_4.onTouched.call$0();
        this._NumberValueAccessor_7_5.onTouched.call$0();
      }, "call$1", "get$_handle_blur_7_2", 2, 0, 3],
      _handle_change_7_3$1: [function($$event) {
        var t1, t2;
        t1 = this._NumberValueAccessor_7_5;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_change_7_3", 2, 0, 3],
      static: {
        ViewPowerBoostCalculatorComponent0$: function(parentView, parentIndex) {
          var t1 = new A.ViewPowerBoostCalculatorComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewPowerBoostCalculatorComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewPowerBoostCalculatorComponentHost0: {
      "^": "AppView;_power_boost_calculator_component_template$_compView_0,_PowerBoostCalculatorComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = A.ViewPowerBoostCalculatorComponent0$(this, 0);
        this._power_boost_calculator_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new F.PowerBoostCalculatorComponent(5, 1);
        this._PowerBoostCalculatorComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._PowerBoostCalculatorComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_VCV && 0 === nodeIndex)
          return this._PowerBoostCalculatorComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._power_boost_calculator_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._power_boost_calculator_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  }], ["", "package:pipe_examples/src/power_booster_component.dart",, K, {
    "^": "",
    PowerBoosterComponent: {
      "^": "Object;"
    }
  }], ["", "package:pipe_examples/src/power_booster_component.template.dart",, U, {
    "^": "",
    viewFactory_PowerBoosterComponentHost0: [function(parentView, parentIndex) {
      var t1 = new U._ViewPowerBoosterComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "power_booster_component_template__viewFactory_PowerBoosterComponentHost0$closure", 4, 0, 5],
    initReflector8: function() {
      ...
      L.initReflector9();
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_PowerBoosterComponent_TfG, C.ComponentFactory_GYv);
    },
    ViewPowerBoosterComponent0: {
      "^": "AppView;_power_booster_component_template$_el_0,_power_booster_component_template$_el_2,_power_booster_component_template$_text_3,_power_booster_component_template$_expr_0,_power_booster_component_template$_pipe_exponentialStrength_0,_power_booster_component_template$_pipe_exponentialStrength_0_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewPowerBoosterComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("power-booster");
        this.rootEl = t1;
        t1 = $.ViewPowerBoosterComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewPowerBoosterComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        doc = document;
        t1 = S.createAndAppend(doc, "h2", parentRenderNode);
        this._power_booster_component_template$_el_0 = t1;
        t1.appendChild(doc.createTextNode("Power Booster"));
        t1 = S.createAndAppend(doc, "p", parentRenderNode);
        this._power_booster_component_template$_el_2 = t1;
        t2 = doc.createTextNode("");
        this._power_booster_component_template$_text_3 = t2;
        t1.appendChild(t2);
        t2 = new M.ExponentialStrengthPipe();
        this._power_booster_component_template$_pipe_exponentialStrength_0 = t2;
        this._power_booster_component_template$_pipe_exponentialStrength_0_0 = Q.pureProxy2(t2.get$transform(t2));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var t1, currVal_0;
        t1 = this._power_booster_component_template$_pipe_exponentialStrength_0_0.call$2(2, 10);
        currVal_0 = "Super power boost: " + (t1 == null ? "" : H.S(t1));
        if (this._power_booster_component_template$_expr_0 !== currVal_0) {
          this._power_booster_component_template$_text_3.textContent = currVal_0;
          this._power_booster_component_template$_expr_0 = currVal_0;
        }
      },
      static: {
        ViewPowerBoosterComponent0$: function(parentView, parentIndex) {
          var t1 = new U.ViewPowerBoosterComponent0(null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewPowerBoosterComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewPowerBoosterComponentHost0: {
      "^": "AppView;_power_booster_component_template$_compView_0,_PowerBoosterComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = U.ViewPowerBoosterComponent0$(this, 0);
        this._power_booster_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new K.PowerBoosterComponent();
        this._PowerBoosterComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._PowerBoosterComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_PowerBoosterComponent_TfG && 0 === nodeIndex)
          return this._PowerBoosterComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._power_booster_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._power_booster_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  ...
  C.ComponentFactory_2Vk = new D.ComponentFactory("hero-birthday", G.hero_birthday1_component_template__viewFactory_HeroBirthdayComponentHost0$closure(), C.List_empty, [U.HeroBirthdayComponent]);
  C.ComponentFactory_A4F = new D.ComponentFactory("flying-heroes", M.flying_heroes_component_template__viewFactory_FlyingHeroesComponentHost0$closure(), C.List_empty, [K.FlyingHeroesComponent]);
  ...
  C.ComponentFactory_GYv = new D.ComponentFactory("power-booster", U.power_booster_component_template__viewFactory_PowerBoosterComponentHost0$closure(), C.List_empty, [K.PowerBoosterComponent]);
  C.ComponentFactory_K13 = new D.ComponentFactory("power-boost-calculator", A.power_boost_calculator_component_template__viewFactory_PowerBoostCalculatorComponentHost0$closure(), C.List_empty, [F.PowerBoostCalculatorComponent]);
  C.ComponentFactory_MQk = new D.ComponentFactory("hero-birthday2", A.hero_birthday2_component_template__viewFactory_HeroBirthday2ComponentHost0$closure(), C.List_empty, [Q.HeroBirthday2Component]);
  C.ComponentFactory_ckG = new D.ComponentFactory("flying-heroes-impure", M.flying_heroes_component_template__viewFactory_FlyingHeroesImpureComponentHost0$closure(), C.List_empty, [K.FlyingHeroesImpureComponent]);
  ...
  C.ComponentFactory_oyU = new D.ComponentFactory("hero-message", F.hero_async_message_component_template__viewFactory_HeroAsyncMessageComponentHost0$closure(), C.List_empty, [K.HeroAsyncMessageComponent]);
...
;
  ...
  C.List_4QF = Isolate.makeConstantList(["#flyers._ngcontent-%COMP%,#all._ngcontent-%COMP% { font-style:italic; }"]);
  C.List_5_6 = Isolate.makeConstantList([5, 6]);
  C.Hero_Windstorm_true = new T.Hero("Windstorm", true);
  C.Hero_Bombasto_false = new T.Hero("Bombasto", false);
  C.Hero_Magneto_false = new T.Hero("Magneto", false);
  C.Hero_Tornado_true = new T.Hero("Tornado", true);
  C.List_6L0 = H.setRuntimeTypeInfo(Isolate.makeConstantList([C.Hero_Windstorm_true, C.Hero_Bombasto_false, C.Hero_Magneto_false, C.Hero_Tornado_true]), [T.Hero]);
  ...
  C.List_MDg = Isolate.makeConstantList([".flyers._ngcontent-%COMP%,.all._ngcontent-%COMP% { font-style:italic; }"]);
  ...
  C.Type_FlyingHeroesComponent_0 = H.createRuntimeType("FlyingHeroesComponent");
  C.Type_FlyingHeroesImpureComponent_cWY = H.createRuntimeType("FlyingHeroesImpureComponent");
  ...
  C.Type_HeroAsyncMessageComponent_9nO = H.createRuntimeType("HeroAsyncMessageComponent");
  C.Type_HeroBirthday2Component_Feh = H.createRuntimeType("HeroBirthday2Component");
  C.Type_HeroBirthdayComponent_AC0 = H.createRuntimeType("HeroBirthdayComponent");
  ...
  C.Type_PowerBoosterComponent_TfG = H.createRuntimeType("PowerBoosterComponent");
  ...
  C.Type_VCV = H.createRuntimeType("PowerBoostCalculatorComponent");
  ...
  $._visited2 = false;
  $._visited30 = false;
  $.ViewFlyingHeroesComponent0__renderType = null;
  $.ViewFlyingHeroesImpureComponent0__renderType = null;
  $._visited34 = false;
  $._visited35 = false;
  $.ViewHeroAsyncMessageComponent0__renderType = null;
  $._visited33 = false;
  $.ViewHeroBirthdayComponent0__renderType = null;
  $._visited32 = false;
  $.ViewHeroBirthday2Component0__renderType = null;
  $._visited31 = false;
  $.ViewHeroListComponent0__renderType = null;
  $._visited29 = false;
  $.ViewPowerBoostCalculatorComponent0__renderType = null;
  $._visited3 = false;
  $.ViewPowerBoosterComponent0__renderType = null;
  $._visited1 = false;
  $._visited = false;
  $ = null;
  ...
  (function(lazies) {
  ...
  }, "_dartProxyCtor", "_promiseStrategy", "$get$_promiseStrategy", function() {
    return new B.PromiseStrategy();
  }, "_promiseStrategy", "_observableStrategy", "$get$_observableStrategy", function() {
    return new B.ObservableStrategy();
  }, "_observableStrategy", "DatePipe__ALIASES", "$get$DatePipe__ALIASES", function() {
    return P.LinkedHashMap__makeLiteral(["medium", "yMMMdjms", "short", "yMdjm", "fullDate", "yMMMMEEEEd", "longDate", "yMMMMd", "mediumDate", "yMMMd", "shortDate", "yMd", "mediumTime", "jms", "shortTime", "jm"]);
  }, "DatePipe__ALIASES", "_multiPartRegExp", "$get$_multiPartRegExp", function() {
    return P.RegExp_RegExp("^([yMdE]+)([Hjms]+)$", true, false);
  }, "_multiPartRegExp", "trackByIdentity", "$get$trackByIdentity", function() {
    ...
    return P.LinkedHashMap__makeLiteral(["alt", new N.closure2(), "control", new N.closure3(), "meta", new N.closure4(), "shift", new N.closure5()]);
  }, "modifierKeyGetters", "en_USSymbols", "$get$en_USSymbols", function() {
    return new B.DateSymbols("en_US", C.List_BC_AD, C.List_6xs, C.List_qpm, C.List_qpm, C.List_cIc, C.List_cIc, C.List_h8w, C.List_h8w, C.List_wMy, C.List_wMy, C.List_gc6, C.List_gc6, C.List_3US, C.List_3US, C.List_Q1_Q2_Q3_Q4, C.List_bJM, C.List_AM_PM, C.List_cno, C.List_kWG, C.List_iDZ, null, 6, C.List_5_6, 5, null);
  ...
  $ = new Isolate();
  init.metadata = ["index", "self", "parent", "zone", null, "error", "_", "p0", "stackTrace", "value", "p1", "fn", "arg", "result", "callback", "o", "date", "e", "arg1", "arg2", "f", "invocation", "elem", "data", "findInAncestors", "arguments", "object", "x", "p2", "event", "sender", "element", "arg4", "k", "v", "numberOfArguments", "name", "xhr", "zoneValues", "captureThis", "closure", "isolate", "ref", "s", "arg3", "errorCode", "theError", "item", "theStackTrace", "each", "specification", "duration", "clazz", "deps", "stack", "reason", "key", "binding", "exactMatch", true, "timer", "didWork_", "t", "eventObj", "trace", "err"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, v: true, args: [,]}, {func: 1, args: [,,]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Function]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.String, args: [P.DateTime]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: [S.AppView, K.FlyingHeroesImpureComponent], args: [S.AppView, P.num]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, ret: P.String}, {func: 1, ret: W.Element, args: [P.int]}, {func: 1, ret: W.Node, args: [P.int]}, {func: 1, ret: W.MimeType, args: [P.int]}, {func: 1, ret: P.Future}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, args: [,], named: {rawValue: P.String}}, {func: 1, ret: [S.AppView, K.FlyingHeroesComponent], args: [S.AppView, P.num]}, {func: 1, ret: W.SpeechGrammar, args: [P.int]}, {func: 1, ret: [P.List, W.RtcStatsReport]}, {func: 1, ret: W.SourceBuffer, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, ret: W.SpeechRecognitionAlternative, args: [P.int]}, {func: 1, ret: W.Touch, args: [P.int]}, {func: 1, ret: W.TrackDefault, args: [P.int]}, {func: 1, ret: W.VttRegion, args: [P.int]}, {func: 1, ret: P.Rectangle, args: [P.int]}, {func: 1, ret: W.CssRule, args: [P.int]}, {func: 1, ret: W.Gamepad, args: [P.int]}, {func: 1, ret: W._Attr, args: [P.int]}, {func: 1, ret: W.SpeechRecognitionResult, args: [P.int]}, {func: 1, ret: W.StyleSheet, args: [P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, ret: P.Map, args: [P.int]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, args: [P.Object]}, {func: 1, ret: P.String, args: [,], opt: [P.String]}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [P.String]}, {func: 1, ret: W.DataTransferItem, args: [P.int]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, ret: [S.AppView, T.HeroListComponent], args: [S.AppView, P.num]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [P.List, Y.NgZone]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [Z.AbstractControl]}, {func: 1, ret: W.File, args: [P.int]}, {func: 1, ret: P.num, args: [P.num, P.num]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: [P.List, T.Hero], args: [[P.List, T.Hero]]}, {func: 1, ret: P.num}, {func: 1, args: [P.Timer]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, ret: P.bool, args: [,]}, {func: 1, args: [W.HttpRequest]}, {func: 1, args: [P.String,,]}, {func: 1, ret: W.Plugin, args: [P.int]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}];
